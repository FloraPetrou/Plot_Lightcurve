...
df['flux_ref']= df['flux']*((887491000.0/df['freq'])**args.alpha)
df['flux_err_ref']= df['flux_err']*((887491000.0/df['freq'])**args.alpha)
...
on.to_csv(args.source_name + '_on.csv', index=False)
off.to_csv(args.source_name + '_off.csv', index=False)
